...
class ProxyingRecorder(object):
    ...
    def __init__(self, fp, proxy_client, digest_algorithm='sha1', url=None,
                 tmp_file_max_memory_size=524288, interrupt_on_terminate=False, stop=None):
        self.fp = fp
...
class ProxyingRecordingHTTPResponse(http_client.HTTPResponse):
    ...
    def __init__(
        ...
        self.recorder = ProxyingRecorder(
                ...
                interrupt_on_terminate=interrupt_on_terminate, stop=stop)
...
class MitmProxyHandler(http_server.BaseHTTPRequestHandler):
    ...
    def setup(self):
        http_server.BaseHTTPRequestHandler.setup(self)
    ...
    def finish(self):
        http_server.BaseHTTPRequestHandler.finish(self)
